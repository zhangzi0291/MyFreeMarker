		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<div class="box-title">新增${className}</div>
				</div>
				<div class="box-body">
					<form action="${r'${basePath }'}/${className?uncap_first}/add.json" method="post" class="form-horizontal">
					    ...
					    <#list attrs as attr> 
 						<div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                        	<input type="text" class="form-control" name="${attr.camel}">
	                        </div>
	                    </div>
			  			</#list> 
